package be.domaindrivendesign.ecole.laitecole.domain.model;

import be.domaindrivendesign.ecole.laitecole.domain.type.CodeProduitType;
import be.domaindrivendesign.ecole.laitecole.domain.type.UniteProduitType;
