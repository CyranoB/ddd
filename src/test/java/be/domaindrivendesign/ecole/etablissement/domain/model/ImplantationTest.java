...
public class ImplantationTest {
    ...
    public void testCreerNullNumeroReference() {
        ...
        Assert.assertEquals(getInstance().getViolations().get(0).getPropertyPaths(),
                singletonList("be.domaindrivendesign.ecole.etablissement.domain.model|Implantation.getNumeroReference"));
    ...
    public void testCreerNullDenomination() {
        ...
        Assert.assertEquals(1, getInstance().getViolations().size());
        Assert.assertNull(getInstance().getViolations().get(0).getMessage());
        Assert.assertEquals(singletonList("be.domaindrivendesign.ecole.etablissement.domain.model|Implantation.getDenomination"), getInstance().getViolations().get(0).getPropertyPaths());
        Assert.assertEquals(RuleType.Mandatory.typeValue, getInstance().getViolations().get(0).getRuleId());
        Assert.assertEquals(implantation, getInstance().getViolations().get(0).getRuleObject());
        Assert.assertEquals(RuleSeverityType.Error, getInstance().getViolations().get(0).getSeverityType());
        Assert.assertEquals(Collections.emptyList(), getInstance().getViolations().get(0).getValues());
    ...
    public void testCreerNullAdresse() {
        ...
        Assert.assertEquals(1, getInstance().getViolations().size());
        Assert.assertNull(getInstance().getViolations().get(0).getMessage());
        Assert.assertEquals(singletonList("be.domaindrivendesign.ecole.etablissement.domain.model|Implantation.getAdresse"), getInstance().getViolations().get(0).getPropertyPaths());
        Assert.assertEquals(RuleType.Mandatory.typeValue, getInstance().getViolations().get(0).getRuleId());
        Assert.assertEquals(implantation, getInstance().getViolations().get(0).getRuleObject());
        Assert.assertEquals(RuleSeverityType.Error, getInstance().getViolations().get(0).getSeverityType());
        Assert.assertEquals(Collections.emptyList(), getInstance().getViolations().get(0).getValues());
    ...
    public void testCreerNullNiveauType() {
        ...
        Assert.assertEquals(1, getInstance().getViolations().size());
        Assert.assertNull(getInstance().getViolations().get(0).getMessage());
        Assert.assertEquals(singletonList("be.domaindrivendesign.ecole.etablissement.domain.model|Implantation.getNiveaux"), getInstance().getViolations().get(0).getPropertyPaths());
    ...
    public void testCreerNullValidte() {
        ...
        Assert.assertEquals(1, getInstance().getViolations().size());
        Assert.assertNull(getInstance().getViolations().get(0).getMessage());
        Assert.assertEquals(singletonList("be.domaindrivendesign.ecole.etablissement.domain.model|Implantation.getValidite"), getInstance().getViolations().get(0).getPropertyPaths());
        Assert.assertEquals(RuleType.Mandatory.typeValue, getInstance().getViolations().get(0).getRuleId());
        Assert.assertEquals(implantation, getInstance().getViolations().get(0).getRuleObject());
        Assert.assertEquals(RuleSeverityType.Error, getInstance().getViolations().get(0).getSeverityType());
        Assert.assertEquals(Collections.emptyList(), getInstance().getViolations().get(0).getValues());
