...
public class EcoleServiceImplTest {
    ...
    public void testListEtablissement() {
        ...
        ((EtablissementRepositoryMock) etablissementRepository).clear();
    }
    ...
    public void testGetEtablissement() {
        ...
        Agrement agrement = AgrementRepositoryDtoMock.getAgrement01(UUID.randomUUID(), "NumeroDgarne01");
        agrementRepository.insert(agrement);
        ...
        ((AgrementRepositoryDtoMock) agrementRepository).clear();
        ((EtablissementRepositoryMock) etablissementRepository).clear();
    }
}
