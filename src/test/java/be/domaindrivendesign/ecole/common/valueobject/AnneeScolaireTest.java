...
public class AnneeScolaireTest {
    ...
    public void testConstrutor_BadAnneeDebut() {
        ...
        Assert.assertArrayEquals(Collections.singletonList("be.domaindrivendesign.ecole.common.valueobject|AnneeScolaire.getAnneeDebut").toArray(), UnitOfWorkRule.getInstance().getViolations().get(0).getPropertyPaths().toArray());
    }
    ...
    public void testConstrutor_BadAnneeFin() {
        ...
        Assert.assertArrayEquals(Collections.singletonList("be.domaindrivendesign.ecole.common.valueobject|AnneeScolaire.getAnneeFin").toArray(), UnitOfWorkRule.getInstance().getViolations().get(0).getPropertyPaths().toArray());
    }
