...
import be.domaindrivendesign.ecole.module.beneficiaire.domain.type.BeneficiaireCategorieType;
...
public class BeneficiciareTest {
    ...
    public void testCreerNullDenomination() {
        ...
        Assert.assertEquals(Arrays.asList("be.domaindrivendesign.ecole.module.beneficiaire.domain.model|Beneficiaire.getDenomination"), UnitOfWorkRule.getInstance().getViolations().get(0).getPropertyPaths());
    ...
    public void testCreerNullCompteBancaire() {
        ...
        Assert.assertEquals(1, UnitOfWorkRule.getInstance().getViolations().size());
        Assert.assertNull(UnitOfWorkRule.getInstance().getViolations().get(0).getMessage());
        Assert.assertEquals(Arrays.asList("be.domaindrivendesign.ecole.module.beneficiaire.domain.model|Beneficiaire.getCompteBancaire"), UnitOfWorkRule.getInstance().getViolations().get(0).getPropertyPaths());
        Assert.assertEquals(RuleType.Mandatory.typeValue, UnitOfWorkRule.getInstance().getViolations().get(0).getRuleId());
        Assert.assertEquals(beneficiaire, UnitOfWorkRule.getInstance().getViolations().get(0).getRuleObject());
        Assert.assertEquals(RuleSeverityType.Error, UnitOfWorkRule.getInstance().getViolations().get(0).getSeverityType());
        Assert.assertEquals(Arrays.asList(), UnitOfWorkRule.getInstance().getViolations().get(0).getValues());
    ...
    public void testCreerNullBeneficiaireCategoryType() {
        ...
        Assert.assertEquals(1, UnitOfWorkRule.getInstance().getViolations().size());
        Assert.assertNull(UnitOfWorkRule.getInstance().getViolations().get(0).getMessage());
        Assert.assertEquals(Arrays.asList("be.domaindrivendesign.ecole.module.beneficiaire.domain.model|Beneficiaire.getBeneficiaireCategorie"), UnitOfWorkRule.getInstance().getViolations().get(0).getPropertyPaths());
        Assert.assertEquals(RuleType.Mandatory.typeValue, UnitOfWorkRule.getInstance().getViolations().get(0).getRuleId());
        Assert.assertEquals(beneficiaire, UnitOfWorkRule.getInstance().getViolations().get(0).getRuleObject());
        Assert.assertEquals(RuleSeverityType.Error, UnitOfWorkRule.getInstance().getViolations().get(0).getSeverityType());
        Assert.assertEquals(Arrays.asList(), UnitOfWorkRule.getInstance().getViolations().get(0).getValues());
    ...
    public void testCreerCreche() {
        ...
        Assert.assertEquals(1, UnitOfWorkRule.getInstance().getViolations().size());
        Assert.assertNull(UnitOfWorkRule.getInstance().getViolations().get(0).getMessage());
        Assert.assertEquals(Arrays.asList("be.domaindrivendesign.ecole.module.beneficiaire.domain.model|Beneficiaire.getCrecheNombreDeJours"), UnitOfWorkRule.getInstance().getViolations().get(0).getPropertyPaths());
