package be.domaindrivendesign.ecole.module.beneficiaire.model;
...
public class AgrementTest {
    ...
    public void testCreerNullNumeroDgarne() {
        ...
        assertEquals(Arrays.asList("be.domaindrivendesign.ecole.module.beneficiaire.domain.model|Agrement.getNumeroDgarne"), UnitOfWorkRule.getInstance().getViolations().get(0).getPropertyPaths());
    ...
    public void testCreerNullDateDepot() {
        ...
        assertNull(UnitOfWorkRule.getInstance().getViolations().get(0).getMessage());
        assertEquals(UnitOfWorkRule.getInstance().getViolations().get(0).getPropertyPaths(), Arrays.asList("be.domaindrivendesign.ecole.module.beneficiaire.domain.model|Agrement.getDateDepot"));
    ...
    public void testCreerNullDateDemande() {
        ...
        assertEquals(UnitOfWorkRule.getInstance().getViolations().size(), 1);
        assertNull(UnitOfWorkRule.getInstance().getViolations().get(0).getMessage());
        assertEquals(UnitOfWorkRule.getInstance().getViolations().get(0).getPropertyPaths(), Arrays.asList("be.domaindrivendesign.ecole.module.beneficiaire.domain.model|Agrement.getDateDemande"));
        assertEquals(UnitOfWorkRule.getInstance().getViolations().get(0).getRuleId(), RuleType.Mandatory.typeValue);
        assertEquals(UnitOfWorkRule.getInstance().getViolations().get(0).getRuleObject(), demandeAgrement);
        assertEquals(UnitOfWorkRule.getInstance().getViolations().get(0).getSeverityType(), RuleSeverityType.Error);
        assertEquals(UnitOfWorkRule.getInstance().getViolations().get(0).getValues(), Arrays.asList());
    ...
    public void testCreerNullPremiereAnneeScolaire() {
        ...
        assertEquals(UnitOfWorkRule.getInstance().getViolations().size(), 1);
        assertNull(UnitOfWorkRule.getInstance().getViolations().get(0).getMessage());
        assertEquals(UnitOfWorkRule.getInstance().getViolations().get(0).getPropertyPaths(), Arrays.asList("be.domaindrivendesign.ecole.module.beneficiaire.domain.model|Agrement.getPremiereAnneeScolaire"));
        assertEquals(UnitOfWorkRule.getInstance().getViolations().get(0).getRuleId(), RuleType.Mandatory.typeValue);
        assertEquals(UnitOfWorkRule.getInstance().getViolations().get(0).getRuleObject(), demandeAgrement);
        assertEquals(UnitOfWorkRule.getInstance().getViolations().get(0).getSeverityType(), RuleSeverityType.Error);
        assertEquals(UnitOfWorkRule.getInstance().getViolations().get(0).getValues(), Arrays.asList());
    ...
    public void testCreerNullBeneficiaireId() {
        ...
        assertEquals(UnitOfWorkRule.getInstance().getViolations().size(), 1);
        assertNull(UnitOfWorkRule.getInstance().getViolations().get(0).getMessage());
        assertEquals(UnitOfWorkRule.getInstance().getViolations().get(0).getPropertyPaths(), Arrays.asList("be.domaindrivendesign.ecole.module.beneficiaire.domain.model|Agrement.getBeneficiaireId"));
        assertEquals(UnitOfWorkRule.getInstance().getViolations().get(0).getRuleId(), RuleType.Mandatory.typeValue);
        assertEquals(UnitOfWorkRule.getInstance().getViolations().get(0).getRuleObject(), demandeAgrement);
        assertEquals(UnitOfWorkRule.getInstance().getViolations().get(0).getSeverityType(), RuleSeverityType.Error);
        assertEquals(UnitOfWorkRule.getInstance().getViolations().get(0).getValues(), Arrays.asList());
    ...
    public void testSupprimerAgrementDerniereAnneeScolaireNull() {
        ...
        assertEquals(1, UnitOfWorkRule.getInstance().getViolations().size());
        assertNull(UnitOfWorkRule.getInstance().getViolations().get(0).getMessage());
        assertEquals(Arrays.asList("be.domaindrivendesign.ecole.module.beneficiaire.domain.model|Agrement.getDerniereAnneeScolaire"), UnitOfWorkRule.getInstance().getViolations().get(0).getPropertyPaths());
        assertEquals(RuleType.Mandatory.typeValue, UnitOfWorkRule.getInstance().getViolations().get(0).getRuleId());
        assertEquals(demandeAgrement, UnitOfWorkRule.getInstance().getViolations().get(0).getRuleObject());
        assertEquals(RuleSeverityType.Error, UnitOfWorkRule.getInstance().getViolations().get(0).getSeverityType());
