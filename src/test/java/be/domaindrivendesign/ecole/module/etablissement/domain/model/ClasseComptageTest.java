...
public class ClasseComptageTest {
    ...
    public void TestCreerNullClasseType() {
        ...
        Assert.assertEquals(new ArrayList<>(Collections.singleton("be.domaindrivendesign.ecole.module.etablissement.domain.model|ClasseComptage.getClasse")), UnitOfWorkRule.getInstance().getViolations().get(0).getPropertyPaths());
