...
public class PeriodDateHeureTest {
    ...
    public void testConstructor() {
        ...
        Assert.assertEquals(debut, periode1.getDebut());
        Assert.assertEquals(fin, periode1.getFin());
    }
    ...
    public void testModifierDebut() {
        ...
        Assert.assertEquals(LocalDateTime.parse("2015-01-01T00:00:00"), periode2.getFin());
        Assert.assertEquals(LocalDateTime.parse("2000-01-01T00:00:00"), periode2.getDebut());
    }
    ...
    public void testModifierFin() {
        ...
        Assert.assertEquals(LocalDateTime.parse("2010-01-01T00:00:00"), periode2.getFin());
        Assert.assertEquals(LocalDateTime.parse("2000-01-01T00:00:00"), periode2.getDebut());
    }
    ...
    public void testModifierDuree() {
        ...
        Assert.assertEquals(new PeriodDateHeure(LocalDateTime.parse("2000-01-01T00:00:00"), LocalDateTime.parse("2000-01-16T00:00:00")), periode2);
    }
    ...
    public void testCreerUnJourAPartirDe() {
        ...
        Assert.assertEquals(LocalDateTime.parse("2000-01-02T00:00:00"), unJour.getFin());
    ...
    public void testChevauchement() {
        ...
        Assert.assertTrue(PeriodDateHeure.chevauchements(periode1, periode2));

        PeriodDateHeure periode3 = periode1.modifierDebut(LocalDateTime.parse("2000-01-21T00:00:00"));
        Assert.assertFalse(PeriodDateHeure.chevauchements(periode2, periode3));
    }
    ...
    public void testPasDeChevauchement() {
        ...
        Assert.assertFalse(PeriodDateHeure.chevauchements(periode1, periode2));
    }
    ...
    public void testChevauchementList() {
        ...
        Assert.assertTrue(PeriodDateHeure.chevauchements(periode1, Arrays.asList(periode2, periode3)));
    }
    ...
    public void testComprend() {
        ...
        Assert.assertTrue(PeriodDateHeure.comprend(periode1, periode2));
    }
    ...
    public void testNeComprendPas() {
        ...
        Assert.assertFalse(PeriodDateHeure.comprend(periode1, periode2));
    }
}
