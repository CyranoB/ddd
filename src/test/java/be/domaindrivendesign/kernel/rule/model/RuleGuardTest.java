...
public class RuleGuardTest implements Serializable {
    ...
    public void testEquals() {
        ...
        // No violation
        Assert.assertTrue(RuleGuard.equalsTo(ruleObject01, () -> ruleObject01.getAttribute01(), () -> ruleObject02.getAttribute02(), RuleSeverityType.Warning));
        Assert.assertEquals(0, UnitOfWorkRule.getInstance().getViolations().size());

        // Violation
        ruleObject02.setAttribute02(2);
        Assert.assertFalse(RuleGuard.equalsTo(ruleObject01, () -> ruleObject01.getAttribute01(), () -> ruleObject02.getAttribute02(), RuleSeverityType.Warning));
    ...
    public void testEqualsWithoutSeverity() {
        ...
        // No violation
        Assert.assertTrue(RuleGuard.equalsTo(ruleObject01, () -> ruleObject01.getAttribute01(), () -> ruleObject02.getAttribute02()));
        Assert.assertEquals(0, UnitOfWorkRule.getInstance().getViolations().size());

        // Violation
        ruleObject02.setAttribute02(2);
        Assert.assertFalse(RuleGuard.equalsTo(ruleObject01, () -> ruleObject01.getAttribute01(), () -> ruleObject02.getAttribute02()));
    ...
    public void testEqualsTemporal() {
        ...
        // No violation
        Assert.assertTrue(RuleGuard.equalsTo(ruleObject01, () -> ruleObject01.getLocalDateTime01(), () -> ruleObject02.getLocalDateTime02(), RuleSeverityType.Warning));
        Assert.assertEquals(0, UnitOfWorkRule.getInstance().getViolations().size());

        // Violation
        ruleObject02.setLocalDateTime02(LocalDateTime.of(2016, 1, 1, 0, 0));
        Assert.assertFalse(RuleGuard.equalsTo(ruleObject01, () -> ruleObject01.getLocalDateTime01(), () -> ruleObject02.getLocalDateTime02(), RuleSeverityType.Warning));
    ...
    public void testEqualsTemporalWithoutSeverity() {
        ...
        // No violation
        Assert.assertTrue(RuleGuard.equalsTo(ruleObject01, () -> ruleObject01.getLocalDateTime01(), () -> ruleObject02.getLocalDateTime02()));
        Assert.assertEquals(0, UnitOfWorkRule.getInstance().getViolations().size());

        // Violation
        ruleObject02.setLocalDateTime02(LocalDateTime.of(2016, 1, 1, 0, 0));
        Assert.assertFalse(RuleGuard.equalsTo(ruleObject01, () -> ruleObject01.getLocalDateTime01(), () -> ruleObject02.getLocalDateTime02()));
    ...
    public void testEqualsString() {
        ...
        // No violation Smaller
        Assert.assertTrue(RuleGuard.equalsTo(ruleObject01, () -> ruleObject01.getString01(), () -> ruleObject02.getString02(), RuleSeverityType.Warning));
        Assert.assertEquals(0, UnitOfWorkRule.getInstance().getViolations().size());

        // Violation
        ruleObject02.setString02("test");

        Assert.assertFalse(RuleGuard.equalsTo(ruleObject01, () -> ruleObject01.getString01(), () -> ruleObject02.getString02(), RuleSeverityType.Warning));
    ...
    public void testEqualsStringWithoutSeverity() {
        ...
        // No violation Smaller
        Assert.assertTrue(RuleGuard.equalsTo(ruleObject01, () -> ruleObject01.getString01(), () -> ruleObject02.getString02()));
        Assert.assertEquals(0, UnitOfWorkRule.getInstance().getViolations().size());

        // Violation
        ruleObject02.setString02("test");

        Assert.assertFalse(RuleGuard.equalsTo(ruleObject01, () -> ruleObject01.getString01(), () -> ruleObject02.getString02()));
    ...
    public void testMandatoryClass() {
        ...
        Assert.assertTrue(RuleGuard.mandatoryClass(ruleObject, RuleSeverityType.Warning));
        Assert.assertEquals(0, UnitOfWorkRule.getInstance().getViolations().size());

        // Violation
        ruleObject = null;

        Assert.assertFalse(RuleGuard.mandatoryClass(ruleObject, RuleSeverityType.Warning));

        Assert.assertEquals(UnitOfWorkRule.getInstance().getViolations().get(0).getRuleObject(), ruleObject);
        Assert.assertNull(UnitOfWorkRule.getInstance().getViolations().get(0).getMessage());
        Assert.assertArrayEquals(UnitOfWorkRule.getInstance().getViolations().get(0).getPropertyPaths().toArray(), new String[0]);
    ...
    @Test
    public void testMandatoryClassWithoutSeverity() {
        RuleObject01 ruleObject = new RuleObject01();

        Assert.assertTrue(RuleGuard.mandatoryClass(ruleObject));
        Assert.assertEquals(0, UnitOfWorkRule.getInstance().getViolations().size());

        // Violation
        ruleObject = null;

        Assert.assertFalse(RuleGuard.mandatoryClass(ruleObject));
    ...
    @Test
    public void testNotInListWithoutSeverity01() {
        RuleObject01 ruleObject = new RuleObject01();
    ...
    @Test
    public void testNotInList02() {
        RuleObject01 ruleObject = new RuleObject01();

        ruleObject.setLists01(Arrays.asList(2, 3, 4));

        // No violation
        Assert.assertTrue(RuleGuard.notInList(ruleObject, () -> ruleObject.getLists01(), 1, RuleSeverityType.Warning));
        Assert.assertEquals(0, UnitOfWorkRule.getInstance().getViolations().size());

        ruleObject.setLists01(Arrays.asList(1, 2, 3));

        // Violation
        Assert.assertFalse(RuleGuard.notInList(ruleObject, () -> ruleObject.getLists01(), 1, RuleSeverityType.Warning));
        ...
        Assert.assertEquals(UnitOfWorkRule.getInstance().getViolations().get(0).getRuleId(), RuleType.NotInList.typeValue);
        Assert.assertEquals(UnitOfWorkRule.getInstance().getViolations().get(0).getSeverityType(), RuleSeverityType.Warning);
        Assert.assertArrayEquals(UnitOfWorkRule.getInstance().getViolations().get(0).getValues().toArray(), Arrays.asList("1", "2", "3", "1").toArray());
    }

    @Test
    public void testNotInListWithoutSeverity02() {
        RuleObject01 ruleObject = new RuleObject01();

        ruleObject.setLists01(Arrays.asList(2, 3, 4));

        // No violation
        Assert.assertTrue(RuleGuard.notInList(ruleObject, () -> ruleObject.getLists01(), 1));
        Assert.assertEquals(0, UnitOfWorkRule.getInstance().getViolations().size());

        ruleObject.setLists01(Arrays.asList(1, 2, 3));

        // Violation
        Assert.assertFalse(RuleGuard.notInList(ruleObject, () -> ruleObject.getLists01(), 1));
